...
(custom-set-faces
 ...
 '(magit-blame-date ((t (:inherit magit-blame-heading :foreground nil :background nil))) t)
 '(magit-blame-hash ((t (:inherit magit-blame-heading :foreground nil :background nil))) t)
 '(magit-blame-heading ((t (:background "grey25" :foreground "white"))))
 '(magit-blame-name ((t (:inherit magit-blame-heading :foreground nil :background nil))) t)
 '(magit-blame-summary ((t (:inherit magit-blame-heading :foreground nil :background nil))) t)
